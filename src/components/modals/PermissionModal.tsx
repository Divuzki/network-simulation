  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mb-6">
          <p className="mb-4">
            This action will scan your local network to detect connected devices. It will:
          </p>
          ...
          <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
            We do not store or transmit any of this information outside of your browser. 
        ...
        <div className="flex justify-end space-x-3">
          ...
          <button 
            className={`btn flex items-center space-x-2 ${
              hasConsented ? 'btn-primary' : 'btn-secondary opacity-50 cursor-not-allowed'
            }`}
            onClick={handleScan}
